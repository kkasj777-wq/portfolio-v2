...
export default function Ferrofluid({
  ...
  useEffect(() => {
    ...
    const onPointerMove = (event) => {
      ...
      mouseTarget[0] = (event.clientX - rect.left) * ratio;
      mouseTarget[1] = (rect.height - (event.clientY - rect.top)) * ratio;
  ...
  }, [colors, dpr, flowDirection, fluidity, glow, mouseDampening, mouseInteraction, mouseRadius, mouseStrength, opacity, rimWidth, scale, sharpness, shimmer, speed, turbulence]);
